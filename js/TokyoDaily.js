...
(function() {
  ...
  $('#graph').html("<svg width='" + FrameW + "' height='" + FrameH + "'>  <g transform='translate(" + Margin.left + "," + Margin.top + ")'>    <rect class='bg' x='0' y='0' width='" + Width + "' height='" + Height + "' />    <g class='x axis' transform='translate(0," + Height + ")' />    <g class='y axis temp'>      <text class='y axis' x='" + (-Height / 2) + "' y='-4.5em'       transform='rotate(-90)'>Temperature (℃)</text>    </g>    <g class='y axis prec' transform='translate(" + Width + ",0)'>      <text class='y axis' x='" + (-Height / 2) + "' y='5em'       transform='rotate(-90)'>Precipitation (mm/day)</text>    </g>    <path class='graph prec area' />    <path class='graph temp area' stroke-width='0.2' />    <rect class='pane' width='" + Width + "' height='" + Height + "' />  </g></svg>");
  ...
  $.ajax("data/tokyo_daily.dp6").done(function(data) {
    onLoadData(data);
